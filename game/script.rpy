...
label start:
    ...
    narrator "The room has very little light, but what you can see seems well furnished. The pillow you are laying on looks like satin."

    unknown "*Growl*"

    narrator "That’s definitely your stomach. You successfully get onto all four legs to try and look around for food scraps or a trash can."

    unknown "There’s gotta be a little snack hidden around here…"

    narrator "You find a basket with what looks like treats! Your tummy growls louder as if begging you to dig in. One bite tells you that it is wrapped in plastic, leaving the snack crushed behind its clear shell."

    unknown "Noooo!"

    narrator "Your whine sounds out as you drag the plastic wrapped treat out using your paws to try and free your snack."

    unknown "*Squeak*"

    narrator "Your ears perk as it sounds like a door squeak, followed by footsteps. Someone is coming! You thought at first to be happy someone could open up your treat, only to realize you have no idea if this person is friendly. You grab your snack and sneak under the table to check out who was about to walk into the room."

    unknownWoman "Little doggie, I’m back home!"

    narrator "A small light comes in as she closes the door behind her. Hopefully you didn’t need that to escape."

    unknownWoman "…"

    unknownWoman "Little doggie?"

    narrator "Sounds like she’s calling for you."
    ...
    menu:
        ...
        "Come out from table":
            ...
            narrator "You slowly peek your head out with your snack still hanging from your mouth."

        "Stay underneath":

            narrator "You stay under the table guarding the snack. She peeks her head underneath, instantly spotting you. Busted."

    unknownWoman "There you are. What’s that you got?"

    narrator "She takes the treat from you to take a better look at it. She gasps before putting it away and then grabbing the basket and putting it on the table out of reach."

    unknown "*Whine, whine*"

    unknownWoman "Sorry, puppy, you can’t have chocolate. If you’re hungry, I have something that will be much better."

    narrator "You don’t know what would be better, but you sit patiently as she reaches for something on a high shelf."

    unknownWoman "Here, some yummy and safe dog food."

    narrator "You see what looks like a couple small sausages. Your mouth waters before you give a quick sniff to check if it’s safe. You then happily tear into your meal."

    unknownWoman "Glad you like it."

    narrator "You finish your meal with gusto before going to sit back on your pillow. The human had just been watching this whole time. She stares at you with great interest, as if you were the only thing in the room."

    unknownWoman "All done?"

    narrator "You give a little nod as you lay. Now fed, you thought about why you were here. You know you didn’t have anyone you belonged to. The last thing you remember is digging through trash, actually. You also hadn’t even made a note that you understand this human and she seemed to understand you."

    unknown "Bark!"

    narrator "No words came out of your mouth, but you were trying to ask why you were here. Not like you had anywhere else to be, but you’d like to know who this person was and what they wanted with you."

    unknownWoman "Settle down, you can’t talk, silly. I can explain as long as you can understand me."

    narrator "Another nod as you prepared to hear what she had to say."

    unknownWoman "First, I found you and was letting you heal from your accident."

    narrator "She gestures to your hind leg. It felt funny, but hadn’t noticed anything else wrong with it. That and your head barely lets you see it. You can see something on it that looks like a sock."

    unknownWoman "I’m happy to see you recovering quickly. I think you’ve noticed you’re not an ordinary little dog, are you?"

    narrator "She has a point. Not most dogs understand humans. Other dogs could learn names or commands, but you knew every word. Even the ones you didn’t want to hear."
    ...
    menu:
        ...
        "Nod head":
            ...
            narrator "You nod your head. She seems delighted and scoops you up from the pillow in her arms."

        "Give questioning look":

            narrator "You give her a look to try and portray your uneasy feeling."

            unknownWoman "I promise you won’t be harmed."

            narrator "You look at your feet mulling it over for a moment before nodding. She scoops you up from the pillow into her arms."

    narrator "You have a new view of the room from a better vantage point. It looks messy with how many books, crystals, plants, and other things are strewn about. You are soon placed on a chair on the other side of the room."

    unknownWoman "Stay here for one moment. I’ll be right back."

    narrator "You sit and stay like a good dog. You hope she’ll give you a little pet for being good. Then again, you were unsure about this test. Most things you knew were about sitting, staying, and occasionally, playing dead. Your greedy tummy hoped she’d be back with a box of treats."

    narrator "It didn’t take long before she appeared back with a small delicate box. Your tail wags in excitement."

    unknownWoman "Don’t get too excited, this isn’t for treats."

    narrator "Your little head droops and your tail stops as your hopes are crushed. You do get a pat on the head with a scritch behind the ear. Seems like she doesn’t like seeing a pouty face."

    unknownWoman "Alright then, let’s begin shall we?"

    narrator "She opens the box and the necklace is inside. You give it a sniff before she lifts it to show it off. It hangs from a gold chain down to a big red gem at the end. You know humans love this stuff. Even you can appreciate that it sparkles and looks pretty."
    ...
    narrator "You are not really sure what that means, but the way she stares at the necklace with intensity, you know it must be important."

    unknownWoman "What I plan to do is give this to you. I want to undo what has been done and I think you’ll be able to do it."

    narrator "You tilt your head. She’s being really vague and also you’re a dog. A smart and adorable dog. But a dog."
    ...
    narrator "You figure that she knows what she’s talking about and at least you’ll give it a try."
    ...
    narrator "Your tail wiggles as you try to stay still. You think putting on a necklace shouldn’t hurt so you’re looking forward to an easy treat."
